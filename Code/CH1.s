...
;LABEL      DIRECTIVE   VALUE       COMMENT
            ...
            EXPORT      CH1      ; Make available

CH1			; Initialise conditions for Read Multiple for low Data Ch0
			
			;PUSH	{LR}
			MOV		R11, LR
			; Initialise conditions for Read Multiple for low Data Ch1
			
			LDR 	R0, =0x39         	; Load slave_address into R0
			LDR 	R2, =0x8E         	; Load slave_memory_address into R2
			LDR 	R3, =1            	; Load bytes_count into R3
			LDR 	R7, =lowDataCH1   	; Load address of data array into R4
			...
			; Initialise conditions for Read Multiple for high Data Ch1
			
			LDR 	R0, =0x39         	; Load slave_address into R0
			LDR 	R2, =0x8F         	; Load slave_memory_address into R2
			LDR 	R3, =1            	; Load bytes_count into R3
			LDR 	R7, =highDataCH1   	; Load address of data array into R4
